...
import { FaReact, FaNodeJs, FaAws, FaAngular, FaGithub, FaLinkedin, FaTwitter, FaCode, FaMobile, FaCloud } from 'react-icons/fa';
          ...
          <div className="md:w-1/2">
            <AnimatedSection delay={200}>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4">
                Hi, I'm <span className="text-blue-600 dark:text-teal-400">John Doe</span>
              </h1>
            </AnimatedSection>
