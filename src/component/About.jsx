...
export const About = () => {
  const skills = [
    ...
    { name: 'Express', icon: <SiExpress className="w-8 h-8 text-gray-800 dark:text-gray-200" /> },
  ...
  return (
    <section id="about" className="py-20 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row gap-12">
          <div className="md:w-1/2">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              My approach combines technical expertise with a keen eye for user experience, ensuring that
              the applications I build are not only functional but also intuitive and engaging.
            </p>
            <p className="text-gray-600 dark:text-gray-300">
              When I'm not coding, you can find me contributing to open-source projects, writing technical
              blogs, or exploring new technologies in the ever-evolving world of web development.
            </p>
          </div>
          <div className="md:w-1/2">
            ...
            <div className="mt-8">
              ...
              <div className="flex flex-wrap gap-2">
                {['REST APIs', 'WebSocket', 'SQL', 'NoSQL', 'Git', 'CI/CD', 'Microservices', 'Serverless'].map(
                  (skill, index) => (
                  <span
                    key={index}
